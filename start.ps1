...
Write-Host "  USFK BidTrack - 로컬 개발 서버 시작" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""
...
if (-not (Test-Path "$projectPath\node_modules")) {
    ...
    Write-Host "[1/2] 패키지 확인 완료" -ForegroundColor Green
}

Write-Host ""
Write-Host "[2/2] 개발 서버 시작 중..." -ForegroundColor Yellow
Write-Host ""
